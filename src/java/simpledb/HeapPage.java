...
public class HeapPage implements Page {
    ...
    */
    private int getNumTuples() {
        final double floor = Math.floor(BufferPool.getPageSize() * 8 / (td.getSize() * 8 + 1));
        return (int) floor;
    }
    ...
    private int getHeaderSize() {
        final double ceil = Math.ceil((float) getNumTuples() / 8);
        return (int) ceil;
    }
    ...
    public void deleteTuple(Tuple t) throws DbException {
        ...
        if( tupleNumber >= numSlots || !isSlotUsed(tupleNumber)){
    ...
    public boolean isSlotUsed(int i) {
        assert i < numSlots;
        final int index = i / 8;
        final byte b = this.header[index];
    ...
    private void markSlotUsed(int i, boolean value) {
        assert i < numSlots;
        final int index = i / 8;
        byte b = this.header[index];
        if(value){
            b = (byte) ((b | (0x01 << i % 8)) & 0xff);
        }else{
            b = (byte)(b & (~ (0x01 << i % 8)) & 0xff);
        }
        this.header[index] = b;
